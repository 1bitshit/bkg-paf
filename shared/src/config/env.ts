...
export const ENV = {
  ...
  OPENCLAUDE: {
    COMMAND: getEnvString('OPENCLAUDE_COMMAND', 'openclaude'),
    CONFIG_DIR: getEnvString('OPENCLAUDE_CONFIG_DIR', ''),
    WORKING_DIR: getEnvString('OPENCLAUDE_WORKING_DIR', ''),
  },

  NIM: {
    API_KEY: getEnvString('NVIDIA_API_KEY', ''),
    BASE_URL: getEnvString('NIM_BASE_URL', 'https://integrate.api.nvidia.com/v1'),
  },
